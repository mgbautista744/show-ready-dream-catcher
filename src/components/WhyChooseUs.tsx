...
export function WhyChooseUs() {
  return (
    <section className="py-20 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-30" style={{backgroundImage: "url(\"data:image/svg+xml;charset=utf-8,%3Csvg viewBox='0 0 100 100' xmlns='http://www.w3.org/2000/svg'%3E%3Ccircle cx='50' cy='50' r='2' fill='hsl(var(--primary)/0.1)'%3E%3C/circle%3E%3C/svg%3E\")", backgroundRepeat: "repeat"}} />
      ...
      <div className="container mx-auto px-4 relative">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
          {benefits.map((benefit, index) => {
            ...
            return (
              <Card key={index} className={`hover-lift animate-slide-up border-none shadow-lg group cursor-pointer overflow-hidden ${benefit.bgPattern}`} style={{ animationDelay: `${index * 0.1}s` }}>
